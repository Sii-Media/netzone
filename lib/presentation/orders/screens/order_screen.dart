...
class _OrdersScreenState extends State<OrdersScreen> {
            ...
            builder: (context, orderState) {
              if (orderState is GetUserOrdersInProgress) {
                ...
                return orderState.orderList.isEmpty
                    ? _buildEmptyOrder()
                    : _buildOrderList(
                        state: orderState, countryState: countryState);
              }
  ...
  Widget _buildOrderList(
      {required GetUserOrdersSuccess state,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Date: ${formatDateTime(state.orderList[index].createdAt ?? '')}',
                  style: const TextStyle(fontSize: 16.0),
                ),
                const SizedBox(height: 16.0),
                ListView.builder(
                  shrinkWrap: true,
                  itemCount: state.orderList[index].products.length,
                      ...
                      child: ListTile(
                        leading: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl: state.orderList[index].products[indexx]
                                .product.imageUrl,
                            width: 80.w,
                            height: 80.h,
                            fit: BoxFit.contain,
                        ...
                        title: Text(
                          state.orderList[index].products[indexx].product.name,
                          style: const TextStyle(
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text: '${state.orderList[index].grandTotal}',
                              style: const TextStyle(
                                fontWeight: FontWeight.w700,
                              ),
                            ),
