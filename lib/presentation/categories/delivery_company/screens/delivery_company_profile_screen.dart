                          ...
                          Column(
                            children: [
                              titleAndInput(
                                  ...
                                  input: widget.deliveryCompany.username ?? ''),
                              titleAndInput(
                                  title: AppLocalizations.of(context)
                                      .translate('desc'),
                                  input:
                              ...
                              titleAndInput(
                                  title: AppLocalizations.of(context)
                                      .translate('website'),
                                  input: widget.deliveryCompany.website ?? ''),
                              titleAndInput(
                                  title: AppLocalizations.of(context)
                                      .translate('delivery_type'),
                                  input: widget.deliveryCompany.deliveryType ??
                                      ''),
                              titleAndInput(
                                  title: AppLocalizations.of(context)
                                      .translate('deliveryCarsNum'),
                                  input: widget.deliveryCompany.deliveryCarsNum
                                      .toString()),
                              titleAndInput(
                                  title: AppLocalizations.of(context)
