                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        titleAndInput(
                          ...
                          input: widget.realEstate.createdBy.username ?? '',
                        ),
                        SizedBox(
                          height: 7.h,
                        ),
                        titleAndInput(
                          title: AppLocalizations.of(context).translate('area'),
                      ...
                      widget.realEstate.images?.isNotEmpty == true
                          ? SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemCount: widget.realEstate.images!.length,
                                  // gridDelegate:
                                  ...
                                  itemBuilder: (BuildContext context, index) {
                                    return ClipRRect(
                                      ...
                                      child: ListOfPictures(
                                        img: widget.realEstate.images![index],
                                      ),
                                    );
                                  }),
                            )
