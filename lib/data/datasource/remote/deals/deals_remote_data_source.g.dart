...
class _DealsRemoteDataSourceImpl implements DealsRemoteDataSourceImpl {
  ...
  @override
  Future<List<DealsItemsModel>> getUserDeals(String userId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<DealsItemsModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => DealsItemsModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
